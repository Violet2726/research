...
uv run multi_agent_cli run --experiment configs/multi_agent/experiments/debate_vs_vote_controlled.toml --phase smoke20 --model xiaomimimo/mimo-v2.5
uv run multi_agent_cli report-debate-vs-vote --run-dir runs/multi_agent/debate_vs_vote_controlled/smoke20/<run_id>
```
