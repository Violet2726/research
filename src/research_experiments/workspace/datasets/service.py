...
def build_primary_dataset_specs(benchmarks: list[BenchmarkConfig]) -> list[DatasetAssetSpec]:
    ...
    source_map = {
        ...
        "musr": DatasetAssetSpec(
            slug="musr",
            dataset_name="MuSR",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("musr/all.csv"),
            source_kind="hf_file",
            source_label="Official Hugging Face dataset",
            source_url="https://huggingface.co/datasets/TAUR-Lab/MuSR",
            source_split="all",
            repo_id="TAUR-Lab/MuSR",
            repo_type="dataset",
            filename="all.csv",
            revision="7c365b439a222150f317764d4f16ae6c96d7d94a",
            notes="Pinned official MuSR all.csv.",
        ),
        "seqbench": DatasetAssetSpec(
            slug="seqbench",
            dataset_name="seqBench Compact",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("seqbench/seqBench_compact.jsonl.gz"),
            source_kind="hf_file",
            source_label="Official Hugging Face dataset",
            source_url="https://huggingface.co/datasets/emnlp-submission/seqBench",
            source_split="compact",
            repo_id="emnlp-submission/seqBench",
            repo_type="dataset",
            filename="seqBench_compact.jsonl.gz",
            revision="03e4dcb823a62a5e31b5ac2b765459265700a149",
            notes="Pinned official compact seqBench JSONL.GZ.",
        ),
        ...
        "omni_math": DatasetAssetSpec(
            slug="omni_math",
            dataset_name="Omni-MATH",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("omni-math/Omni-Math.jsonl"),
            source_kind="http_file",
            source_label="Official GitHub raw",
        ...
        "bbeh": DatasetAssetSpec(
            ...
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("bbeh/bbeh-main.zip"),
            source_kind="http_file",
