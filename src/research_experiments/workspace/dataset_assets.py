...
def build_primary_dataset_specs(benchmarks: list[BenchmarkConfig]) -> list[DatasetAssetSpec]:
    ...
    source_map = {
        ...
        "humaneval": DatasetAssetSpec(
            slug="humaneval",
            dataset_name="HumanEval",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("humaneval/test.parquet"),
            source_kind="hf_file",
            source_label="Hugging Face dataset",
            ...
            notes="保留 prompt、entry point 与 tests，供 MacNet 本地 pass@1 评测使用。",
        ),
        "commongen_hard": DatasetAssetSpec(
            slug="commongen_hard",
            dataset_name="CommonGen-Hard",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("commongen-hard/commongen_hard_nohuman.json"),
            source_kind="hf_file",
            source_label="Hugging Face dataset",
            source_url="https://huggingface.co/datasets/allenai/commongen_hard",
            source_split="test",
            repo_id="allenai/commongen_hard",
            repo_type="dataset",
        ...
        "grailqa_test": DatasetAssetSpec(
            slug="grailqa_test",
            dataset_name="GrailQA Test",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("grailqa/test.json"),
            source_kind="http_file",
        ...
        "mmlu": DatasetAssetSpec(
            ...
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("mmlu/test.parquet"),
            source_kind="hf_file",
            source_label="Hugging Face dataset",
            source_url="https://huggingface.co/datasets/cais/mmlu",
            source_split="all_test",
            repo_id="cais/mmlu",
            repo_type="dataset",
            filename="all/test-00000-of-00001.parquet",
            notes="使用原始 MMLU all/test 聚合 parquet，避免用 MMLU-Pro 代替 canonical 多选主线。",
        ),
        "mmlu_abstract_algebra": DatasetAssetSpec(
            slug="mmlu_abstract_algebra",
            ...
            repo_type="dataset",
            filename="all/test-00000-of-00001.parquet",
            notes="MMLU abstract_algebra 子集，复用 mmlu/test.parquet，运行时通过 record_filters 过滤。",
        ),
        ...
        "webquestions_paper_test": DatasetAssetSpec(
            slug="webquestions_paper_test",
            dataset_name="WebQuestions Paper Test",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("webquestions/paper_test.json"),
            source_kind="http_file",
            source_label="DoG official GitHub",
        ...
        "webqsp": DatasetAssetSpec(
            slug="webqsp",
            dataset_name="WebQSP",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("webqsp/test.json"),
            source_kind="http_file",
            source_label="DoG official GitHub",
        ...
        "cwq": DatasetAssetSpec(
            slug="cwq",
            dataset_name="CWQ",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("cwq/test.json"),
            source_kind="http_file",
            source_label="DoG official GitHub",
        ...
        "metaqa_1hop": DatasetAssetSpec(
            slug="metaqa_1hop",
            dataset_name="MetaQA 1-hop",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("metaqa/1-hop/test.txt"),
            source_kind="http_file",
            source_label="DoG official GitHub",
            source_url="https://raw.githubusercontent.com/mira-ai-lab/DoG/main/KBQA_TASK/metaqa/dataset/1-hop/qa_test.txt",
            source_split="test",
            notes="DoG 论文复现使用的 MetaQA 1-hop 测试集；运行时还需要共享的 `metaqa/kb.txt` 图后端。",
        ),
        "metaqa_2hop": DatasetAssetSpec(
            slug="metaqa_2hop",
            dataset_name="MetaQA 2-hop",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("metaqa/2-hop/test.txt"),
            source_kind="http_file",
            source_label="DoG official GitHub",
            source_url="https://raw.githubusercontent.com/mira-ai-lab/DoG/main/KBQA_TASK/metaqa/dataset/2-hop/qa_test.txt",
            source_split="test",
            notes="DoG 论文复现使用的 MetaQA 2-hop 测试集；运行时还需要共享的 `metaqa/kb.txt` 图后端。",
        ),
        "metaqa_3hop": DatasetAssetSpec(
            slug="metaqa_3hop",
            dataset_name="MetaQA 3-hop",
            asset_id="evaluation",
            purpose="evaluation",
            relative_path=Path("metaqa/3-hop/test.txt"),
            source_kind="http_file",
            source_label="DoG official GitHub",
            source_url="https://raw.githubusercontent.com/mira-ai-lab/DoG/main/KBQA_TASK/metaqa/dataset/3-hop/qa_test.txt",
            source_split="test",
            notes="DoG 论文复现使用的 MetaQA 3-hop 测试集；运行时还需要共享的 `metaqa/kb.txt` 图后端。",
        ),
    }
    ...
    source_map = {
        ...
        "mmlu": [
            DatasetAssetSpec(
                ...
                asset_id="validation",
                purpose="validation",
                relative_path=Path("mmlu/validation.parquet"),
                source_kind="hf_file",
                source_label="Hugging Face dataset",
                source_url="https://huggingface.co/datasets/cais/mmlu",
                source_split="all_validation",
                repo_id="cais/mmlu",
                repo_type="dataset",
                filename="all/validation-00000-of-00001.parquet",
                notes="供 MacNet 的 topic 诊断与离线抽样使用。",
            ),
            DatasetAssetSpec(
                slug="mmlu",
                dataset_name="MacNet SRDD Profile",
                asset_id="srdd_profile_repo",
                purpose="profile_bank",
                relative_path=Path("macnet/srdd-profile-repo.zip"),
                source_kind="http_file",
                source_label="MacNet official GitHub archive",
                source_url="https://github.com/OpenBMB/ChatDev/archive/refs/heads/macnet.zip",
                source_split="shared",
                notes="包含官方 SRDD_Profile 目录；MacNet family 会直接从 zip 中读取角色 profile 文本。",
        ...
        "metaqa_1hop": [
            DatasetAssetSpec(
                ...
                asset_id="kb",
                purpose="backend",
                relative_path=Path("metaqa/kb.txt"),
                source_kind="http_file",
                source_label="DoG official GitHub",
