...
def summarize_run(run_dir: str | Path) -> dict[str, Any]:
    summary = SummaryTableView.from_metrics_payload(load_metrics_payload(run_dir, family_name="sid_lite"))
...
def render_report(run_dir: str | Path, publish_dir: str | Path | None = None) -> dict[str, Any]:
    ...
    diagnostics = load_json_payload(named_diagnostic_paths(root, family_name="sid_lite")["diagnostics.json"])
