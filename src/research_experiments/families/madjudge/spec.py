...
from research_experiments.families.madjudge.config import load_protocol_config
...
SPEC = get_family_spec("madjudge")
from research_experiments.families.madjudge.config import load_control_catalog, load_roster_config
...
def build_parser() -> argparse.ArgumentParser:
    return build_standard_family_parser(
        ...
        validate_help="Run validation checks for one MADJudge run.",
        report_help="Generate MADJudge analysis and a Chinese markdown report.",
    )
