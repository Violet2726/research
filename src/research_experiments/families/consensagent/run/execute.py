...
def run_experiment(
    ...
    paths = prepare_registered_run_layout("consensagent", resolved_run_root, experiment.name, phase_name, run_id)
    ...
    manifest = finalize_family_manifest(manifest, family_name="consensagent")
