            ...
            "table": {
                ...
                "rows": [
                    [
                        ...
                        str(row.get("math_equivalence_repair_v2_count") or 0),
                        str(row.get("hotpot_span_repair_v2_count") or 0),
                        str(row.get("v5_incremental_corrected_vs_v3") or 0),
                        str(row.get("v5_incremental_harmed_vs_v3") or 0),
                        _signed_float(row.get("v5_actual_gain_vs_v3")),
                        ...
                        str(row.get("free_text_recovered_count") or 0),
                        str(row.get("pairwise_json_recovered_count") or 0),
                        str(row.get("json_truncated_count") or 0),
        ...
        },
        {
            ...
            "table": {
                "headers": [
                    ...
                    "math_repair",
                    "hotpot_repair",
                    "repair_only_corrected",
                    "repair_only_harmed",
                    "repair_only_gain_vs_sc5",
                    "semantic_corrected",
                    "semantic_harmed",
                    "semantic_precision",
                    "repair_bank_corrected",
                    "repair_bank_harmed",
                    "repair_bank_precision",
                    "v8_corrected_vs_v6",
                    "v8_harmed_vs_v6",
                    "v8_gain_vs_v6",
                    "certificate_shadow_corrected",
                    "certificate_shadow_harmed",
                    "certificate_shadow_precision",
                    "certificate_shadow_net_gain",
                    "certificate_shadow_valid",
                    "math_repair_v2",
                    "hotpot_repair_v2",
                    "v5_corrected_vs_v3",
                    "v5_harmed_vs_v3",
                    ...
                    "shadow_harmed",
                    "shadow_precision",
                    "shadow_counterfactual_precision",
                    "shadow_net_gain",
                    "shadow_counterfactual_net_gain",
                    "shadow_cross_view_agreement",
                    "duel_invalid",
                    "free_text_recovered",
                    "pairwise_json_recovered",
                    "json_truncated",
                ...
                "rows": [
                    [
                        ...
                        str(row.get("math_repair_count") or 0),
                        str(row.get("hotpot_span_repair_count") or 0),
                        str(row.get("repair_only_corrected_count") or 0),
                        str(row.get("repair_only_harmed_count") or 0),
                        _signed_float(row.get("repair_only_gain_vs_sc5")),
                        str(row.get("semantic_selector_corrected_count") or 0),
                        str(row.get("semantic_selector_harmed_count") or 0),
                        format_float(row.get("semantic_selector_precision")),
                        str(row.get("repair_bank_corrected_count") or 0),
                        str(row.get("repair_bank_harmed_count") or 0),
                        format_float(row.get("repair_bank_precision")),
                        str(row.get("v8_incremental_corrected_vs_v6") or 0),
                        str(row.get("v8_incremental_harmed_vs_v6") or 0),
                        _signed_float(row.get("v8_actual_gain_vs_v6")),
                        str(row.get("certificate_shadow_corrected_count") or 0),
                        str(row.get("certificate_shadow_harmed_count") or 0),
                        format_float(row.get("certificate_shadow_precision")),
                        _signed_float(row.get("certificate_shadow_net_gain")),
                        str(row.get("certificate_shadow_valid_count") or 0),
                        str(row.get("math_equivalence_repair_v2_count") or 0),
                        str(row.get("hotpot_span_repair_v2_count") or 0),
                        str(row.get("v5_incremental_corrected_vs_v3") or 0),
                        str(row.get("v5_incremental_harmed_vs_v3") or 0),
                        ...
                        str(row.get("shadow_counterfactual_harmed_count") or 0),
                        format_float(row.get("shadow_precision")),
                        format_float(row.get("shadow_counterfactual_precision")),
                        _signed_float(row.get("shadow_net_gain")),
                        _signed_float(row.get("shadow_counterfactual_net_gain")),
                        str(row.get("shadow_cross_view_agreement_count") or 0),
                        str(row.get("duel_invalid_count") or 0),
                        str(row.get("free_text_recovered_count") or 0),
                        str(row.get("pairwise_json_recovered_count") or 0),
                        str(row.get("json_truncated_count") or 0),
...
def _write_paper_summary(path: Path, summary_rows: list[dict[str, Any]]) -> None:
    fieldnames = [
        ...
        "math_repair_count",
        "hotpot_span_repair_count",
        "repair_only_corrected_count",
        "repair_only_harmed_count",
        "repair_only_gain_vs_sc5",
        "semantic_selector_corrected_count",
        "semantic_selector_harmed_count",
        "semantic_selector_precision",
        "repair_bank_corrected_count",
        "repair_bank_harmed_count",
        "repair_bank_precision",
        "v8_incremental_corrected_vs_v6",
        "v8_incremental_harmed_vs_v6",
        "v8_actual_gain_vs_v6",
        "certificate_shadow_corrected_count",
        "certificate_shadow_harmed_count",
        "certificate_shadow_precision",
        "certificate_shadow_net_gain",
        "certificate_shadow_valid_count",
        "math_equivalence_repair_v2_count",
        "hotpot_span_repair_v2_count",
        "v5_incremental_corrected_vs_v3",
        "v5_incremental_harmed_vs_v3",
        "v5_actual_gain_vs_v3",
        "validator_pass_count",
        ...
        "shadow_cross_view_agreement_count",
        "duel_invalid_count",
        "duel_retry_recoverable_count",
        "free_text_recovered_count",
        "pairwise_json_recovered_count",
