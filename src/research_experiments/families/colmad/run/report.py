...
def load_metrics(run_dir: str | Path) -> dict[str, Any]:
    ...
    return load_metrics_payload(run_dir, family_name="colmad")
...
def render_report(
    ...
    protocol_diagnostics = load_json_payload(named_diagnostic_paths(root, family_name="colmad")["protocol_diagnostics.json"])
