...
CRED_REFUTE_QUEUE_V1 = "cred_refute_queue_v1"
CRED_REFUTE_QUEUE_V1_LOCK = "cred_refute_queue_v1_lock"
CRED_METHODS = frozenset({CRED_VOTE_5, CRED_REFUTE_QUEUE_V1, CRED_REFUTE_QUEUE_V1_LOCK})
...
def load_protocol_config(path: str | Path) -> CredMadProtocolConfig:
    ...
    return CredMadProtocolConfig(
        ...
        override_margin=float(payload.get("override_margin", 0.75)),
