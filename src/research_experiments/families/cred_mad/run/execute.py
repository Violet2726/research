...
def run_experiment(
    ...
    run_root = run_root or default_runs_root("cred_mad")
    ...
    run_paths = prepare_registered_run_layout("cred_mad", run_root, experiment.name, phase_name, run_id)
    ...
    try:
        ...
        finalize_run_outputs(run_paths.root, validator=validate_run, validation_path=run_paths.validation)
