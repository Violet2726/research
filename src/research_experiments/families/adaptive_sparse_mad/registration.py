...
def inspect_experiment(experiment_path: str, model_override: str | None) -> dict[str, object]:
    ...
    return {
        ...
        "stage_a_response_format_mode": experiment.stage_a_response_format_mode,
        "adaptive_response_format_mode": experiment.adaptive_response_format_mode,
        "legacy_json_mode": experiment.legacy_json_mode,
