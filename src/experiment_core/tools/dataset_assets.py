...
def build_parser() -> argparse.ArgumentParser:
    ...
    generate.add_argument("--splits-root", default="configs/shared/benchmarks/splits")

    prepare = subparsers.add_parser("prepare-used", help="下载主评测源、重建 split，并刷新说明文档。")
    prepare.add_argument("--configs-root", default="configs")
    prepare.add_argument("--splits-root", default="configs/shared/benchmarks/splits")
    ...
    prepare_all.add_argument("--splits-root", default="configs/shared/benchmarks/splits")
    ...
    refresh.add_argument("--splits-root", default="configs/shared/benchmarks/splits")
