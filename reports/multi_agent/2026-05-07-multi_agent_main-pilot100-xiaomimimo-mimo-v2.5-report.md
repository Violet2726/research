...
- 实验名：`multi_agent_main`
- Phase：`pilot100`
- Prompt Version：`multi_agent_controlled_json`
- Backbone：`xiaomimimo/mimo-v2.5`
- 运行目录：`runs/multi_agent/multi_agent_main/pilot100/20260507T121700Z-multi_agent_main-pilot100-xiaomimimo-mimo-v2.5`
...
- 题量：`100`
- initial vote 准确率：`0.6800`
- debate vote 准确率：`0.7300`
- 准确率变化：`+0.0500`
- debate 修正题数：`5`
- debate 改坏题数：`0`
- 保持正确题数：`68`
...
- debate 后一致率：`0.9100`
- debate 翻票率：`0.0500`
- debate 增量 token / 题：`1190.72`
- debate 增量时延 / 题：`5390.76 ms`
- 每 1k debate token 的准确率增益：`+0.041991`
- McNemar exact p：`0.0625`
- Bootstrap 95% CI：`[0.01, 0.1]`
